...
../hornet -c config_private_tangle.json \
--cooBootstrap \
--cooStartIndex 0 \
...
--db.path="privatedb" \
--node.disablePlugins="" \
--node.enablePlugins="Autopeering,Spammer,Coordinator,MQTT,Debug,Prometheus,Faucet" \
...
--p2p.bindMultiAddresses="/ip4/0.0.0.0/tcp/15600" \
--p2p.autopeering.bindAddress="0.0.0.0:14626" \
...
--p2p.peers="/ip4/192.168.96.3/tcp/15601/p2p/12D3KooWCKwcTWevoRKa2kEBputeGASvEBuDfRDSbe8t1DWugUmL"
