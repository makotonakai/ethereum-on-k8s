...
--db.path="privatedb2" \
--node.disablePlugins="" \
--node.enablePlugins="Autopeering,Spammer,MQTT,Debug,Prometheus" \
...
--p2p.bindMultiAddresses="/ip4/0.0.0.0/tcp/15601" \
--p2p.autopeering.bindAddress="0.0.0.0:14627" \
...
--p2p.peers="/ip4/192.168.96.2/tcp/15600/p2p/12D3KooWSagdVaCrS14GeJhM8CbQr41AW2PiYMgptTyAybCbQuEY"
